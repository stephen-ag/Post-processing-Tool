...
for j in folder:
    if j=='B11':
        ...
        for i in li:
            ...
            b11u = filenames[1]-filenames[0]
            b11u.columns=['σxx','σyy','σzz','τxy','τyz','τzx']
            b11u.to_excel('b11u_'+name+'.xlsx',sheet_name='input',index = False)

            b12u = filenames[3]-filenames[2]
            b12u.columns=['σxx','σyy','σzz','τxy','τyz','τzx']
            b12u.to_excel('b12u_'+name+'.xlsx',sheet_name='input',index = False)

            b12d = filenames[5]-filenames[4]
            b12d.columns=['σxx','σyy','σzz','τxy','τyz','τzx']
            b12d.to_excel('b12d_'+name+'.xlsx',sheet_name='input',index = False)

            b11d = filenames[6]-filenames[5]
            b12d.columns=['σxx','σyy','σzz','τxy','τyz','τzx']
            b12d.to_excel('b11d_'+name+'.xlsx',sheet_name='input',index = False)
