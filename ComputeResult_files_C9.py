...
for j in folder:
    if j=='C9':
        ...
        for i in li:
            ...
            c9d = filenames[1]-filenames[0]
            c9d.columns=['σxx','σyy','σzz','τxy','τyz','τzx']
            c9d.to_excel('c9d_'+name+'.xlsx',sheet_name='input',index = False)

            c9u= filenames[2]-filenames[1]
            c9u.columns=['σxx','σyy','σzz','τxy','τyz','τzx']
            c9u.to_excel('c9u_'+name+'.xlsx',sheet_name='input',index = False)
