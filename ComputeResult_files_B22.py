...
for j in folder:
    if j=='B22':
        ...
        for i in li:
            ...
            c4u = filenames[1]-filenames[0]
            c4u.columns= column_list
            c4u.to_excel('c4u_'+name+'.xlsx',sheet_name='input',index = False)

            b2u = filenames[1]-filenames[0]
            b2u.columns=['σxx','σyy','σzz','τxy','τyz','τzx']
            b2u.to_excel('b2u_'+name+'.xlsx',sheet_name='input',index = False)

            b2d = filenames[2]-filenames[1]
            b2d.columns=['σxx','σyy','σzz','τxy','τyz','τzx']
            b2d.to_excel('b2d_'+name+'.xlsx',sheet_name='input',index = False)
